...
export class NewGroupComponent implements OnInit {
        ...
        this.groupService.create(this.model)
            .then((group) => {
                this.dialogService.alert(
                    'In real app (with server) new friends with emails will receive invite to register. But not here... not now...');
    ...
    chooseFriend(friend, i): void {
        friend.userId = friend.id; // fix id because we recive user models (not friend)
